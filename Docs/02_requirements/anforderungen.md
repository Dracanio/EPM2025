...
|-----|------------|-------------|-----------|
| NF1 | Datenschutz | Einhaltung der Hochschul-DSGVO-Richtlinien | Hoch |
| NF2 | Stabilität | Langlebiges System, keine häufigen Updates nötig | Hoch |
...
- Wie könnten wir die Erstellung von Hochschulpostern für Studierende vereinfachen, ohne komplexe Software wie Figma nötig zu machen?  
- Wie könnten wir sicherstellen, dass jedes Poster den Style Guide automatisch einhält?  
- Wie könnten wir die Kollaboration zwischen Studierenden und Lehrenden effizient gestalten?  
- Wie könnten wir die Wiederverwendung von Vorjahrespostern oder Templates einfach ermöglichen?  
- Wie könnten wir die Nutzung auf Touch-Devices wie iPads für wenig technikaffine Nutzer ermöglichen?  
